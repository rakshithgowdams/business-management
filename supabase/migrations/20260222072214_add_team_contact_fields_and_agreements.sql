/*
  ...
  1. Modified Tables
    - `project_team`
      - Added `phone` (text) - team member phone number
      - Added `email` (text) - team member email address
      - Added `employment_type` (text) - Freelancer / Full-time / Part-time
  ...
  2. New Tables
    - `project_agreements`
      ...
      - `team_member_id` (uuid, FK to project_team, nullable)
      - `title` (text) - agreement title/name
      - `agreement_type` (text) - Employee / Freelancer / Project / NDA / Other
  ...
  3. Storage
    - Create private `project-agreements` bucket for agreement files
    - RLS policies: users can upload/read/delete only their own files
